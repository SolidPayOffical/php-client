...
use Solidpay\API\Constants;
use Solidpay\API\Response;

/**
 * @class      Solidpay_Request
 * @since      0.1.0
 * @package    Solidpay
 * @category   Class
 */
...
{
    /**
     * Contains Solidpay_client instance
     *
     * @access public
     * @var Client
     */
    ...
    /**
     * Improves http_build_query() for the Solidpay use case.
     *
